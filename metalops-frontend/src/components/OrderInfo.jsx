  ...
  return (
    <div className='p-4'>
      ...
      <table className='flex w-full'>
        <tbody>
          ...
          <tr>
            ...
            <td>:</td>
            <td className='px-2'>{order.customerId}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>:</td>
            <td className='px-2'>{order.orderStatus}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>:</td>
            <td className='px-2'>{order.paymentStatus}</td>
          </tr>
        </tbody>
      </table>
      ...
      <div className='mt-4 flex gap-4'>
        <button className='border rounded-lg py-2 px-4 bg-blue-600 text-white text-sm flex items-center justify-center gap-2 w-1/2' onClick={editOrder}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" />
          </svg>
          <div>Edit</div>
        </button>
        <button className='border rounded-lg py-2 px-4 bg-red-600 text-white text-sm flex items-center justify-center gap-2 w-1/2' onClick={removeOrder}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
